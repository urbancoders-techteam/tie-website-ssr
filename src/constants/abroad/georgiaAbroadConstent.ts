...
export const georgiaTopUniversityCards: AbroadTopUniversityCard[] = [
  {
    ...
    headerTags: [
      ...
      { label: "Rank #2", variant: "amber" },
    ],
    rankTag: "Ranked #2 in provided Georgia MBBS sheet",
    headerEmoji: "🏛️",
    imageSrc: geoImg("geomedi.jpg"),
    stats: [
      { label: "FMGE (2024)", value: "29.64%" },
      { label: "6-year total", value: "₹43,83,800" },
      { label: "2nd yr onwards", value: "₹6,60,300" },
      { label: "Fees (USD/yr)", value: "$5,500" },
    ],
    fmge: {
      type: "text",
      text: "Intake: Oct/Nov/Mar/Apr · Campus: University Geomedi.",
    },
    description: [
      "Sheet data indicates a strong rank position with balanced fee structure and multiple yearly intakes.",
    ],
    featureTags: ["Tbilisi", "Rank #2", "Oct/Nov/Mar/Apr", "WHO Listed"],
    applyHref: "/contact",
    availabilityText: "Seats Available 2026-27",
  },
  {
    id: "dtmu",
    name: "David Tvildiani Medical University (Pvt.)",
    abbreviation: "DTMU",
    established: "1989",
    locationLine: "Tbilisi",
    region: "moscow",
    ...
    headerTags: [
      { label: "NMC Approved", variant: "emerald" },
      { label: "WHO Listed", variant: "sky" },
      { label: "Rank #5", variant: "amber" },
    ],
    rankTag: "Ranked #5 in provided Georgia MBBS sheet",
    subtitle: "DTMU – Tbilisi, Georgia",
    headerEmoji: "🔬",
    imageSrc: geoImg("dtmu.jpg"),
    stats: [
      { label: "FMGE (2024)", value: "48.5%" },
      { label: "6-year total", value: "₹46,62,800" },
      { label: "2nd yr onwards", value: "₹7,06,800" },
      { label: "Fees (USD/yr)", value: "$6,000" },
    ],
    fmge: {
      type: "text",
      text: "Intake: Oct/Nov/Mar/Apr · Campus: DTMU campus.",
    },
    description: [
      "High FMGE percentage in the sheet with stable fee profile and multiple admission windows.",
    ],
    featureTags: ["Tbilisi", "Rank #5", "High FMGE", "WHO Listed"],
    applyHref: "/contact",
    availabilityText: "Seats Available 2026-27",
  },
  {
    ...
    headerTags: [
      { label: "NMC Approved", variant: "emerald" },
      { label: "WHO Listed", variant: "sky" },
      { label: "Rank #8", variant: "amber" },
    ],
    rankTag: "Ranked #8 in provided Georgia MBBS sheet",
    headerEmoji: "🎓",
    imageSrc: geoImg("uog.png"),
    stats: [
      { label: "FMGE (2024)", value: "60%" },
      { label: "6-year total", value: "₹49,41,800" },
      { label: "2nd yr onwards", value: "₹7,53,300" },
      { label: "Fees (USD/yr)", value: "$6,500" },
    ],
    fmge: {
      type: "text",
      text: "Intake: Oct/Nov/Mar/Apr · Campus: University of Georgia medical campus.",
    },
    description: [
      "Among the stronger FMGE performers in the shared sheet with higher fee bracket.",
    ],
    featureTags: ["Tbilisi", "Rank #8", "FMGE 60%", "Oct/Nov/Mar/Apr"],
    applyHref: "/contact",
    availabilityText: "Seats Available 2026-27",
  },
  {
    id: "batumi_avicenna",
    name: "Batumi Avicenna Medical University",
    abbreviation: "BAMU",
    established: "2022",
    locationLine: "Batumi",
    region: "other",
    ...
    headerTags: [
      { label: "NMC Approved", variant: "emerald" },
      { label: "WHO Listed", variant: "sky" },
      { label: "Rank #19", variant: "amber" },
    ],
    rankTag: "Ranked #19 in provided Georgia MBBS sheet",
    headerEmoji: "🌊",
    stats: [
      { label: "FMGE (2024)", value: "0%" },
      { label: "6-year total", value: "₹42,35,000" },
      { label: "2nd yr onwards", value: "₹6,41,700" },
      { label: "Fees (USD/yr)", value: "$4,900" },
    ],
    fmge: {
      type: "text",
      text: "Intake: Oct/Nov/Mar/Apr · Campus: Avicenna medical campus, Batumi.",
    },
    description: [
      "Newest option in the list with lower fee band and Batumi city location.",
    ],
    featureTags: ["Batumi", "Budget Band", "Rank #19", "Oct/Nov/Mar/Apr"],
    applyHref: "/contact",
    availabilityText: "Seats Available 2026-27",
  },
  {
    ...
    headerTags: [
      { label: "NMC Approved", variant: "emerald" },
      { label: "WHO Listed", variant: "sky" },
      { label: "Rank #29", variant: "amber" },
    ],
    rankTag: "Ranked #29 in provided Georgia MBBS sheet",
    headerEmoji: "📚",
    imageSrc: geoImg("isu.jpg"),
    stats: [
      { label: "FMGE (2024)", value: "Not listed" },
      { label: "6-year total", value: "₹47,46,500" },
      { label: "2nd yr onwards", value: "₹7,25,400" },
      { label: "Fees (USD/yr)", value: "$5,900" },
    ],
    fmge: {
      type: "text",
      text: "Intake: Oct/Nov/Mar/Apr · Public university track.",
    },
    description: [
      "Public university option in Tbilisi with mid-premium fee range in the sheet.",
    ],
    featureTags: ["Public University", "Tbilisi", "Rank #29", "Oct/Nov/Mar/Apr"],
    applyHref: "/contact",
    availabilityText: "Seats Available 2026-27",
  },
  {
    ...
    headerTags: [
      { label: "NMC Approved", variant: "emerald" },
      { label: "WHO Listed", variant: "sky" },
      { label: "Rank #30", variant: "amber" },
    ],
    rankTag: "Ranked #30 in provided Georgia MBBS sheet",
    headerEmoji: "🏫",
    imageSrc: geoImg("gnuseu.jpg"),
    stats: [
      { label: "FMGE (2024)", value: "60.39%" },
      { label: "6-year total", value: "₹47,93,000" },
      { label: "2nd yr onwards", value: "₹7,34,700" },
      { label: "Fees (USD/yr)", value: "$5,900" },
    ],
    fmge: {
      type: "text",
      text: "Intake: Oct/Nov/Mar/Apr · Campus: Faculty of Medicine SEU.",
    },
    description: [
      "Higher FMGE line in the provided sheet with central Tbilisi location.",
    ],
    featureTags: ["Tbilisi", "FMGE 60.39%", "Rank #30", "Oct/Nov/Mar/Apr"],
    applyHref: "/contact",
    availabilityText: "Seats Available 2026-27",
  },
  {
    ...
    headerTags: [
      { label: "NMC Approved", variant: "emerald" },
      { label: "WHO Listed", variant: "sky" },
      { label: "Rank #35", variant: "amber" },
    ],
    rankTag: "Ranked #35 in provided Georgia MBBS sheet",
    headerEmoji: "⚖️",
    imageSrc: geoImg("ewtu.webp"),
    stats: [
      { label: "FMGE (2024)", value: "0%" },
      { label: "6-year total", value: "₹36,77,000" },
      { label: "2nd yr onwards", value: "₹5,48,700" },
      { label: "Fees (USD/yr)", value: "$3,900" },
    ],
    fmge: {
      type: "text",
      text: "Intake: Oct/Nov/Mar/Apr · One of the lower fee options in the sheet.",
    },
    description: [
      "Lower cost university in Tbilisi with newer establishment year.",
    ],
    featureTags: ["Tbilisi", "Budget-Friendly", "Rank #35", "Oct/Nov/Mar/Apr"],
    applyHref: "/contact",
    availabilityText: "Seats Available 2026-27",
  },
  {
    ...
    headerTags: [
      { label: "NMC Approved", variant: "emerald" },
      { label: "WHO Listed", variant: "sky" },
      { label: "Rank #39", variant: "amber" },
    ],
    rankTag: "Ranked #39 in provided Georgia MBBS sheet",
    subtitle: "CIU – Tbilisi, Georgia",
    headerEmoji: "🌍",
    imageSrc: geoImg("ciu.jpg"),
    stats: [
      { label: "FMGE (2024)", value: "33.02%" },
      { label: "6-year total", value: "₹46,62,800" },
      { label: "2nd yr onwards", value: "₹7,06,800" },
      { label: "Fees (USD/yr)", value: "$6,000" },
    ],
    fmge: {
      type: "text",
      text: "Intake: Oct/Nov/Mar/Apr · Campus: Faculty of Medicine.",
    },
    description: [
      "Established private option in Tbilisi with mid-range FMGE and premium fee band.",
    ],
    featureTags: ["Tbilisi", "Rank #39", "FMGE 33.02%", "Oct/Nov/Mar/Apr"],
    applyHref: "/contact",
    availabilityText: "Seats Available 2026-27",
  },
  {
    ...
    headerTags: [
      { label: "NMC Approved", variant: "emerald" },
      { label: "WHO Listed", variant: "sky" },
      { label: "Rank #42", variant: "amber" },
    ],
    rankTag: "Ranked #42 in provided Georgia MBBS sheet",
    headerEmoji: "🩺",
    imageSrc: geoImg("eeu.png"),
    stats: [
      { label: "FMGE (2024)", value: "22.95%" },
      { label: "6-year total", value: "₹44,76,800" },
      { label: "2nd yr onwards", value: "₹6,60,300" },
      { label: "Fees (USD/yr)", value: "$5,500" },
    ],
    fmge: {
      type: "text",
      text: "Intake: Oct/Nov/Mar/Apr · Campus: East European University.",
    },
    description: [
      "Tbilisi-based option with moderate fee structure and lower FMGE in the provided sheet.",
    ],
    featureTags: ["Tbilisi", "Rank #42", "FMGE 22.95%", "Oct/Nov/Mar/Apr"],
    applyHref: "/contact",
    availabilityText: "Seats Available 2026-27",
  },
  {
    ...
    headerTags: [
      { label: "NMC Approved", variant: "emerald" },
      { label: "WHO Listed", variant: "sky" },
      { label: "Modern Program", variant: "amber" },
    ],
    rankTag: "Ranking not listed in provided sheet",
    headerEmoji: "✨",
    imageSrc: geoImg("alte.webp"),
    stats: [
      { label: "FMGE (2024)", value: "46.67%" },
      { label: "6-year total", value: "₹45,23,300" },
      { label: "2nd yr onwards", value: "₹6,60,300" },
      { label: "Fees (USD/yr)", value: "$5,500" },
    ],
    fmge: {
      type: "text",
      text: "Intake: Oct/Nov/Mar/Apr · Campus: Alte University.",
    },
    description: [
      "Strong FMGE signal in the provided sheet with premium fee profile.",
    ],
    featureTags: ["Tbilisi", "FMGE 46.67%", "Oct/Nov/Mar/Apr", "WHO Listed"],
    applyHref: "/contact",
    availabilityText: "Seats Available 2026-27",
  },
  {
    ...
    headerTags: [
      { label: "NMC Approved", variant: "emerald" },
      { label: "WHO Listed", variant: "sky" },
      { label: "High FMGE", variant: "amber" },
    ],
    rankTag: "Ranking not listed in provided sheet",
    headerEmoji: "🏥",
    stats: [
      { label: "FMGE (2024)", value: "63.29%" },
      { label: "6-year total", value: "₹39,93,200" },
      { label: "2nd yr onwards", value: "₹5,95,200" },
      { label: "Fees (USD/yr)", value: "$4,800" },
    ],
    fmge: {
      type: "text",
      text: "Intake: Oct/Nov · Campus: BAU International University.",
    },
    description: [
      "One of the strongest FMGE percentages in the provided table with lower fee band.",
    ],
    featureTags: ["Tbilisi", "FMGE 63.29%", "Oct/Nov", "Value Option"],
    applyHref: "/contact",
    availabilityText: "Seats Available 2026-27",
  },
  {
    ...
    headerTags: [
      { label: "NMC Approved", variant: "emerald" },
      { label: "WHO Listed", variant: "sky" },
      { label: "Top FMGE", variant: "amber" },
    ],
    rankTag: "Ranking not listed in provided sheet",
    headerEmoji: "⭐",
    stats: [
      { label: "FMGE (2024)", value: "80.33%" },
      { label: "6-year total", value: "₹47,55,800" },
      { label: "2nd yr onwards", value: "₹7,06,800" },
      { label: "Fees (USD/yr)", value: "$6,000" },
    ],
    fmge: {
      type: "text",
      text: "Intake: Oct/Nov · Campus: Medical School of Georgian American University.",
    },
    description: [
      "Highest FMGE percentage in the provided sheet among listed Georgia universities.",
    ],
    featureTags: ["Tbilisi", "FMGE 80.33%", "Oct/Nov", "Premium Track"],
    applyHref: "/contact",
    availabilityText: "Seats Available 2026-27",
  },
];
...
export const georgiaAbroadTopUniversitiesContent: AbroadTopUniversitiesContent = {
  ...
  topFmgeFilterIds: ["gau", "bau", "uog", "gnu_seu"],
  universities: georgiaTopUniversityCards,
  quickComparison: {
    title: "Quick Comparison — Universities from Provided Sheet",
    disclaimer:
    ...
    rows: [
      {
        ...
        annualFees: "$5,500/yr",
        fmgeRate: "29.64%",
        bestFor: "Rank #2 · Oct/Nov/Mar/Apr intake",
      },
      {
        university: "David Tvildiani (Pvt.)",
        city: "Tbilisi",
        established: "1989",
        annualFees: "$6,000/yr",
        fmgeRate: "48.5%",
        fmgeHighlight: true,
        bestFor: "Rank #5 · DTMU campus",
      },
      {
        university: "University of Georgia",
        city: "Tbilisi",
        ...
        fmgeRate: "60%",
        fmgeHighlight: true,
        bestFor: "Rank #8 · Oct/Nov/Mar/Apr intake",
      },
      {
        university: "Batumi Avicenna",
        city: "Batumi",
        established: "2022",
        annualFees: "$4,900/yr",
        fmgeRate: "0%",
        bestFor: "Rank #19 · Batumi location",
      },
      {
        ...
        annualFees: "$5,900/yr",
        fmgeRate: "Not listed",
        bestFor: "Rank #29 · Public university",
      },
      {
        university: "SEU",
        city: "Tbilisi",
        ...
        fmgeRate: "60.39%",
        fmgeHighlight: true,
        bestFor: "Rank #30 · Faculty of Medicine SEU",
      },
      {
        university: "East-West Teaching Univ.",
        city: "Tbilisi",
        established: "2019",
        annualFees: "$3,900/yr",
        fmgeRate: "0%",
        bestFor: "Rank #35 · Lower fee band",
      },
      {
        university: "CIU",
        city: "Tbilisi",
        ...
        annualFees: "$6,000/yr",
        fmgeRate: "33.02%",
        bestFor: "Rank #39 · Faculty of Medicine",
      },
      {
        university: "EEU",
        city: "Tbilisi",
        ...
        annualFees: "$5,500/yr",
        fmgeRate: "22.95%",
        bestFor: "Rank #42 · Oct/Nov/Mar/Apr",
      },
      {
        ...
        annualFees: "$5,500/yr",
        fmgeRate: "46.67%",
        bestFor: "Strong FMGE in provided sheet",
      },
      {
        university: "BAU International",
        city: "Tbilisi",
        established: "2015",
        annualFees: "$4,800/yr",
        fmgeRate: "63.29%",
        fmgeHighlight: true,
        bestFor: "High FMGE + lower fee bracket",
      },
      {
        university: "GAU",
        city: "Tbilisi",
        ...
        fmgeRate: "80.33%",
        fmgeHighlight: true,
        bestFor: "Highest FMGE in provided sheet",
      },
    ],
  },
};
