...
// ---------------- Testimonials ----------------
export const RUSSIA_TESTIMONIALS = [
  {
...
// icon: string key; component resolves via ADMISSION_STEP_ICONS
export const RUSSIA_ADMISSION_STEPS = [
  {
    stepLabel: "Step 1",
...
// ---------------- FAQ ----------------
// answer: string; optional highlightTerms[] — phrases to wrap in highlight style
