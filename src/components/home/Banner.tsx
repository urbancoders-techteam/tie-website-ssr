...
/** Mobile: vh-based hero. md+: fill viewport below sticky header (~80px bar + 3px border). */
const SLIDE_HEIGHT = "h-[72vh] min-h-[340px] md:h-[calc(100dvh-83px)]";
...
export default function Banner() {
  ...
  return (
    <>
      ...
      <div className="-mt-10 block px-4 pb-6 md:hidden">
        <RegisterForm floating={false} />
      </div>
    </>
  );
